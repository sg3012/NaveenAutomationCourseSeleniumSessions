...
public class OpenCartProductDetailsTest {
	...
	public void productDetailsTest() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//div[@class='caption']//a[contains(@href,'product&product_id=45')]")).click();
		String actProdName = driver.findElement(By.tagName("h1")).getText();
		Assert.assertEquals(actProdName, "MacBook Pro");
		Thread.sleep(1500);
	}
